 ...
 */
@property(nonatomic,readonly,strong) MixpanelPeople *people;
 ...
 */
@property(nonatomic,weak) id<MixpanelDelegate> delegate; // allows fine grain control over uploading (optional)
